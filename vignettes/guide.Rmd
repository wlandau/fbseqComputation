---
title: "`fbseqComputation` package installation and usage guide"
author: Will Landau
date: 2015
...
vignette: >
  ...
  \VignetteIndexEntry{`fbseqComputation` package installation and usage guide}
...
- The `fbseq` and `fbseqCUDA` packages, available on GitHub. See the vignettes for installation and usage instructions.
